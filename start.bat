...
start /B python ./sandbox/Player/main.py Player Wi-Fi 5670
start /B python ./sandbox/EventKeyBoard/main.py EventKeyBoard Wi-Fi 5670
start /B python ./sandbox/Sound_Manager/main.py Sound_manager Wi-Fi 5670
