...
def on_agent_event_callback(event, uuid, name, event_data, my_data):
    try:
        ...
        assert isinstance(agent_object, Scorer)
...
# inputs
def start_input_callback(iop_type, name, value_type, value, my_data):
    try:
        agent_object = my_data
        assert isinstance(agent_object, Scorer)
        # add code here if needed
...
def score_input_callback(iop_type, name, value_type, value, my_data):
    try:
        agent_object = my_data
        assert isinstance(agent_object, Scorer)
        # add code here if needed
...
if __name__ == "__main__":
    ...
    igs.observe_input("score", score_input_callback, agent)
